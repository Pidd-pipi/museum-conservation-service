...
// opsScheduleTransitionTable drives the conservation schedule state machine.
var opsScheduleTransitionTable = map[OpsScheduleStatus]map[OpsScheduleStatus]bool{
	OpsSchedulePlanned:    {OpsScheduleInspecting: true, OpsScheduleCancelled: true},
	OpsScheduleInspecting: {OpsScheduleVerifying: true, OpsScheduleCancelled: true},
	OpsScheduleVerifying:  {OpsScheduleCancelled: true},
	OpsScheduleTreating:   {OpsScheduleDone: true, OpsScheduleCancelled: true},
	OpsScheduleDone:       {},
	OpsScheduleCancelled:  {},
}

func opsScheduleCanMove(from, to OpsScheduleStatus) bool {
	if from == to {
		return true
	}
	return opsScheduleTransitionTable[from][to]
}
